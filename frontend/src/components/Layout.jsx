...
import { LayoutDashboard, Map, BarChart2, Bot, BellRing, ThermometerSun } from 'lucide-react';
        ...
        <header className="h-20 border-b border-white/5 flex items-center justify-between px-8 z-10 bg-background/50 backdrop-blur-sm">
          ...
          <div className="hidden md:flex items-center space-x-4">
             <div className="flex items-center space-x-2">
                ...
                <span className="text-sm font-medium text-gray-300">Live Environmental Data</span>
             </div>
          </div>
